  ...
  <div class="max-w-7xl mx-auto px-6 mb-32 relative z-10">
    <div class="flex flex-col items-center text-center">
      ...
      <h2 class="text-4xl md:text-5xl font-medium tracking-tight mb-12 max-w-2xl">
        Ready to modernize your alcohol commerce infrastructure?
      </h2>
  ...
  <div class="max-w-7xl mx-auto px-6 relative z-10">
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-12 mb-32 text-sm">
      <div class="space-y-4">
        ...
        <ul class="space-y-3">
          <li><a href="#" class="hover:text-gray-300">Distributors</a></li>
          <li><a href="#" class="hover:text-gray-300">Retailers</a></li>
          <li><a href="#" class="hover:text-gray-300">Brands</a></li>
        </ul>
      </div>
      <div class="space-y-4">
        <h4 class="text-gray-500 font-medium">Products</h4>
        <ul class="space-y-3">
          <li><a href="#" class="hover:text-gray-300">Order Management</a></li>
          <li><a href="#" class="hover:text-gray-300">Compliance Engine</a></li>
          <li><a href="#" class="hover:text-gray-300">ERP Connectors</a></li>
        </ul>
      </div>
      <div class="space-y-4">
        ...
        <ul class="space-y-3">
          ...
          <li><a href="#" class="hover:text-gray-300">Compliance Guide</a></li>
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-3">
          ...
          <li><a href="#" class="hover:text-gray-300">Integration Guides</a></li>
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-3">
          ...
          <li><a href="#" class="hover:text-gray-300">Partners</a></li>
        </ul>
      </div>
      <div class="space-y-4">
    ...
    <!-- Big Logo -->
    <div class="mb-12">
      <h1 class="text-[12vw] leading-none font-bold tracking-tighter text-white opacity-90 select-none">Tipple</h1>
    </div>
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-gray-500 border-t border-white/10 pt-8">
      ...
      <div>
        © 2025 Tipple, Inc. All rights reserved.
      </div>
    </div>
  </div>
</footer>
